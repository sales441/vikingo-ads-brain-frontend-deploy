...
const MOCK = [
  { id:1, name:"Instant Pot Duo 6Qt", asin:"B08XYZ1234", price:79.90, prevPrice:89.90, stock:"in_stock", rating:4.3, reviews:1842, bsr:342, prevBsr:410, priceAlert:true, stockAlert:false },
  { id:2, name:"Tramontina Pressure Cooker 5L", asin:"B07ABC5678", price:119.90, prevPrice:99.90, stock:"in_stock", rating:4.6, reviews:3201, bsr:198, prevBsr:220, priceAlert:false, stockAlert:false },
  { id:3, name:"Oster Stainless Steel 4L", asin:"B09DEF9012", price:64.90, prevPrice:64.90, stock:"low_stock", rating:4.1, reviews:567, bsr:891, prevBsr:750, priceAlert:false, stockAlert:true },
  { id:4, name:"Philips Electric Cooker 6L", asin:"B0AGHI3456", price:149.90, prevPrice:179.90, stock:"out_of_stock", rating:4.4, reviews:2103, bsr:520, prevBsr:480, priceAlert:true, stockAlert:true },
  { id:5, name:"Walita Pressure Cooker 5.5L", asin:"B0BJKL7890", price:98.90, prevPrice:98.90, stock:"in_stock", rating:4.2, reviews:892, bsr:670, prevBsr:710, priceAlert:false, stockAlert:false },
];

const alerts = [
  { type:"price_drop", icon:TrendingDown, color:"text-green-600", bg:"bg-green-50 border-green-200", msg:"Tramontina dropped to $119.90 (was $99.90) — opportunity to compete on price", time:"2h ago" },
  { type:"out_of_stock", icon:Package, color:"text-blue-600", bg:"bg-blue-50 border-blue-200", msg:"Philips 6L went OUT OF STOCK — raise your bids now to capture sales!", time:"45m ago" },
  { type:"price_up", icon:TrendingUp, color:"text-orange-600", bg:"bg-orange-50 border-orange-200", msg:"Oster 4L went up 20% — your products are now more competitive", time:"5h ago" },
];

const stockBadge = { in_stock: { label:"In stock", cls:"bg-green-100 text-green-700" }, low_stock: { label:"Low stock", cls:"bg-yellow-100 text-yellow-700" }, out_of_stock: { label:"Out of stock", cls:"bg-red-100 text-red-700" } };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div><h1 className="text-xl font-bold text-gray-900">Competitor Monitor</h1>
            <p className="text-sm text-gray-500">Real-time price and inventory alerts</p></div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          { label:"Monitored competitors", value: competitors.length, color:"text-gray-800" },
          { label:"Out of stock (opportunity!)", value: opportunities, color:"text-blue-600" },
          { label:"Lowered price today", value: priceDrop, color:"text-green-600" },
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
        <h2 className="text-sm font-semibold text-gray-700 mb-3">Add Competitor</h2>
        <div className="flex gap-2">
          <input value={newAsin} onChange={e => setNewAsin(e.target.value)} placeholder="Paste competitor ASIN (e.g. B08XYZ1234)"
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
          <h2 className="text-sm font-semibold text-gray-700">Monitored Competitors</h2>
          <span className="text-xs text-gray-400">Updated 2 min ago</span>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            <thead><tr className="bg-gray-50">
              {["Product","Price","Change","Inventory","Rating","BSR","Alerts"].map(h => (
              ...
              {competitors.map(c => {
                ...
                return (
                  <tr key={c.id} className={`hover:bg-gray-50 ${c.stock === "out_of_stock" ? "bg-blue-50/30" : ""}`}>
                    ...
                    <td className="px-4 py-3 font-semibold text-gray-800">${c.price.toFixed(2)}</td>
                    <td className="px-4 py-3">
                      {priceChg !== 0 ? (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-gray-400">({c.reviews.toLocaleString("en-US")})</span>
                      </div>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-1">
                        <button onClick={() => toggleAlert(c.id, "priceAlert")} title="Price alert"
                        ...
                        <button onClick={() => toggleAlert(c.id, "stockAlert")} title="Inventory alert"
