  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <KPICard
          title="Gasto Total"
          value={dashboardMetrics.totalSpend}
          delta={dashboardMetrics.spendDelta}
          format="currency"
          icon={DollarSign}
        ...
        <KPICard
          ...
          delta={dashboardMetrics.revenueDelta}
          format="currency"
          icon={TrendingUp}
          iconBg="bg-green-100"
        ...
        <KPICard
          ...
          delta={dashboardMetrics.ordersDelta}
          format="large"
          icon={ShoppingCart}
          iconBg="bg-blue-100"
        ...
        <KPICard
          ...
          delta={dashboardMetrics.impressionsDelta}
          format="large"
          icon={Eye}
        ...
        <KPICard
          ...
          delta={dashboardMetrics.clicksDelta}
          format="large"
        ...
        <KPICard
          ...
          delta={dashboardMetrics.roasDelta}
          format="number"
          icon={Award}
        ...
        <KPICard
          title="ACoS Médio"
          value={dashboardMetrics.avgAcos}
          delta={dashboardMetrics.acosData}
          format="percent"
          icon={Percent}
          iconBg="bg-red-100"
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={spendChartData} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="revenue" name="Receita" stroke="#22c55e" strokeWidth={2}
                fill="url(#colorRevenue)" dot={false} activeDot={{ r: 4 }} />
              <Area type="monotone" dataKey="spend" name="Gasto" stroke="#f97316" strokeWidth={2}
                fill="url(#colorSpend)" dot={false} activeDot={{ r: 4 }} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
